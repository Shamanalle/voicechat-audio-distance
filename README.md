...
| **Fabric** | 26.3 | `voicechat-audio-distance-fabric-1.2.1+mc26.x.jar` | 25+ | 2.6.0+ |
...
| NeoForge / Forge | 26.3 | `voicechat-audio-distance-{neoforge,forge}-1.2.1+mc26.x.jar` | 25+ | 2.6.0+ |
