...
|---|---|---|---|---|
| **Fabric / Quilt** | 1.20 – 1.20.1 | `voice-physics-fabric-1.5.1+mc1.20.1.jar` | 17+ | 1.20.1-2.4.0+ |
| **Fabric / Quilt** | 1.21 – 1.21.11 | `voice-physics-fabric-1.5.1+mc1.21.x.jar` | 21+ | 1.21-2.5.0+ |
| **Fabric** | 26.1 – 26.3 | `voice-physics-fabric-1.5.1+mc26.x.jar` | 25+ | 2.6.0+ |
| **Paper / Purpur / Spigot / Bukkit** (server) | 1.20.1 – 26.3 | `voice-physics-bukkit-1.5.1.jar` | 17+ | Bukkit version |
| Forge | 1.20.1 | `voice-physics-forge-1.5.1+mc1.20.1.jar` | 17+ | 1.20.1-2.4.0+ |
| NeoForge / Forge | 1.21 – 1.21.11 | `voice-physics-{neoforge,forge}-1.5.1+mc1.21.x.jar` | 21+ | 1.21-2.5.0+ |
| **NeoForge** | 26.1 – 26.3 | `voice-physics-neoforge-1.5.1+mc26.x.jar` | 25+ | 2.6.0+ |
| Forge | 26.1 – 26.3 | `voice-physics-forge-1.5.1+mc26.x.jar` | 25+ | 2.6.0+ |
...
1. Put `voice-physics-bukkit-1.5.1.jar` into the server's `plugins/` folder, next to the Bukkit version of Simple Voice Chat.
...
| **Fabric / Quilt** | 1.21 – 1.21.11 | `voice-physics-fabric-1.5.1+mc1.21.x.jar` | 21+ | 1.21-2.5.0+ |
| **Fabric** | 26.1 – 26.3 | `voice-physics-fabric-1.5.1+mc26.x.jar` | 25+ | 2.6.0+ |
| **Paper / Purpur / Spigot / Bukkit** (сервер) | 1.20.1 – 26.3 | `voice-physics-bukkit-1.5.1.jar` | 17+ | версия для Bukkit |
| Forge | 1.20.1 | `voice-physics-forge-1.5.1+mc1.20.1.jar` | 17+ | 1.20.1-2.4.0+ |
| NeoForge / Forge | 1.21 – 1.21.11 | `voice-physics-{neoforge,forge}-1.5.1+mc1.21.x.jar` | 21+ | 1.21-2.5.0+ |
| **NeoForge** | 26.1 – 26.3 | `voice-physics-neoforge-1.5.1+mc26.x.jar` | 25+ | 2.6.0+ |
| Forge | 26.1 – 26.3 | `voice-physics-forge-1.5.1+mc26.x.jar` | 25+ | 2.6.0+ |
...
1. Положите `voice-physics-bukkit-1.5.1.jar` в папку `plugins/` сервера, рядом с версией Simple Voice Chat для Bukkit.
