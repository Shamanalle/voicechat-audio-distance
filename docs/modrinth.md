...
- **One sound for everyone.** Offer or require the server's sound settings, so a PvP match or an event is fair.
...
- **Один звук для всех.** Предложите или сделайте обязательными настройки звука сервера, чтобы PvP или ивент были честными.
